...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{c2_soa/img/physicalAttacks.pdf}
    \caption{Taxonomy of fault injection attacks (inspired by~\cite{CKNDCTD-21-compsec})}
    \label{fig:arbo_fia}
\end{figure}

\subsection{Side-Channel Attacks}
These attacks exploit information leakages on the circuit behaviour such as power consumption, electromagnetic radiation or the execution time of an application.\wip{Ajout d'une image sur les SCA comme figure 1.1 thèse de Noura ?}
