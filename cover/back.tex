...
\keywordsFR{Dynamic Information Flow Tracking, Attaques par Injection de Fautes, Contre-mesures, Code Correcteur d'Erreurs, Code Détecteur d'Erreurs, Processeur Embarqué}
...
\keywordsEN{Dynamic Information Flow Tracking, Fault Injection Attacks, Countermeasures, Error Correction Code, Error Detection Code, Embedded Processor}
