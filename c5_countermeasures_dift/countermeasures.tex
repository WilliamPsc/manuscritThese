...
\begin{table}[t]
    ...
    \begin{tabular}{@{}ccccccccc@{}}
        ...
        \multirow{3}{*}{Compare / Compute} & No protection & 0     & 491    & 7     & —         & —                                                                 & 10          & 508   \\
                                           & Simple parity & 0     &        &       &           & —                                                                 &             &       \\
                                           & Hamming Code  & 0     & 608    & 0     & 0         & 0                                                                 & 0 (0.00\%)  & 608   \\
        \bottomrule
    \end{tabular}
\end{table}

Table~\ref{tab:chap5_results_tempo} presents the results obtained considering the "\textit{single bit-flip in two registers at two clock cycles}" fault model. It shows that without any protection 2,159 fault injections among 241,935 (0.89\%) lead to a successful attack for the buffer overflow use case while we observe 10,160 successes among 451,612 (2.25\%) for the format string use case.
