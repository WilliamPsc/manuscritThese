...
\nomenclature{IFT}{Information Flow Tracking}
...
\nomenclature{EDC}{Error Detecting Code}
\nomenclature{ECC}{Error Correcting Code}
\nomenclature{SECDED}{Single Error Correction, Double Error Detection}
\nomenclature{BCH}{Bose–Chaudhuri–Hocquenghem}
\nomenclature{XSS}{Cross-Site Scripting}
\nomenclature{LFI}{Laser Fault Injections}
\nomenclature{CRT}{Chinese Remainder Theorem}
\nomenclature{ESRF}{European Synchrotron Radiation Facility}
\nomenclature{TMR}{Triple Modular Redundancy}
\nomenclature{EDAC}{Error Detection And Correction Code}
\nomenclature{ROP}{Return-Oriented Programming}