...
\begin{enumerate}
    \item Participation in the science popularisation event "\textit{Ma thèse en 180 secondes}" ({\footnotesize\textit{My PhD Thesis in 180 seconds}}). Rennes, March 2023, \url{https://youtu.be/m_whL8xGbMQ}
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%